...
case class GridFSBucket(private val wrapped: JGridFSBucket) {
   ...
   * @since 2.8
   */
  def uploadFromObservable(filename: String, source: Observable[ByteBuffer]): GridFSUploadObservable[BsonObjectId] =
   ...
   * @since 2.8
   */
  def uploadFromObservable(filename: String, source: Observable[ByteBuffer], options: GridFSUploadOptions): GridFSUploadObservable[BsonObjectId] =
   ...
   * @since 2.8
   */
  def uploadFromObservable(clientSession: ClientSession, filename: String, source: Observable[ByteBuffer]): GridFSUploadObservable[BsonObjectId] =
  ...
  def uploadFromObservable(clientSession: ClientSession, filename: String, source: Observable[ByteBuffer],
                           options: GridFSUploadOptions): GridFSUploadObservable[BsonObjectId] =
