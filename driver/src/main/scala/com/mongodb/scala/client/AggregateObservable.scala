 ...
 */
case class AggregateObservable[T](private val wrapped: AggregateIterable[T]) extends Observable[T] {
   ...
   * @return this
   */
  def allowDiskUse(allowDiskUse: Boolean): AggregateObservable[T] = {
   ...
   * @return this
   */
  def maxTime(duration: Duration): AggregateObservable[T] = {
   ...
   * @return this
   */
  def useCursor(useCursor: Boolean): AggregateObservable[T] = {
